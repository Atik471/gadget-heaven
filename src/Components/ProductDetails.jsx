...
const ProductDetails = () => {
    ...
    return (
        <div className="flex items-center rounded-3xl bg-white w-[60%] p-[2rem] gap-[2rem]">
            <div className="w-[40%]"><img src={`${details.product_image}`} alt="img" className="w-full"/></div>
            <div>
